...
four_arrivals <- subset(long_data_arrivals, Country %in% top_four)

ggplot(long_data_arrivals, aes(x = Year, y = Arrivals, group = Country, color = Country)) +
  geom_line() 
  facet_wrap(~ Country, scales = "free_y") +
  labs(x = "X-axis Label", y = "Y-axis Label", title = "Faceted Line Plot")
```
