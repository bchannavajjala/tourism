...
-   IMF GDP Growth: [https://www.imf.org/external/datamapper/NGDP_RPCH\@WEO/OEMDC/ADVEC/WEOWORLD](https://www.imf.org/external/datamapper/NGDP_RPCH@WEO/OEMDC/ADVEC/WEOWORLD)
    ...
    -   We envision plotting this data on a map with a color scale that helps us visually identify which countries have an overall increase in GDP and which are seeing a decreasing trend in GDP.
